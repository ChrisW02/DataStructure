...
public class quicksort_2 {
    /*
     * A naive implementation of quicksort and its wrapper. It uses extra space
     * for partition. Similar as the first version of binarySort.
     *
     * It's easy to write and let you have the basic ideas of quicksort. Running
     * time: O(n^2).
     */
    ...
    public static void main(String args[]) {
        int testData[][] = { // try different inputs.
                {}, {1, 1, 1, 1, 1, 1, 1}, {10, 8, -4, 89, 2, 0, 4, -19, 200},
                {5, 4, 3, 2, 1, 1, 0, 0, -1},
        ...
        /*
         * int size = 100; int[] a = new int[size]; SecureRandom random = new
         * SecureRandom(); for (int i = 0; i < size; i++) a[i] =
         * random.nextInt(size);
         */
    }
